    ...
    <body class="antialiased">
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mx-auto bg-success border border-info border-start-2 rounded-end mt-16 px-0 sm:items-center sm:justify-between col-md-6">
                <h3 class="m-2 font-semibold text-center">Entrez les informations relatives pour le transfert<h3>
                <form class="row g-3 p-3 mx-auto col-md-8" id="formEnter">
                    ...
                    <div class="">
                        ...
                        <select id="destinateName" name="destinateName" class="form-select">
                            ...
                            <option value="jean DONATIN">Jean DONATIN</option>
                            <option value="Pritilia Hley">Pritilia Hley</option>
                            <option value="Roger Scotte">Roger Scotte</option>
                        </select>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="w-100">
                        <button type="submit" id="send" class="btn btn-primary w-100">Envoyer</button>
                    </div>
                </form>
